...
2. 专业是自己选的
3. 为什么参加比赛 1. 方向 2. 人际
4. 比赛经历积极的影响 1. 抗压能力 2. 自学能力 3. 伙伴
5. 项目基于什么场景 ans: 双11 分布式的数据中心 一致性 可靠性
6. 为什么选择Golang 1. 优点 2. 学校社团
7. 吸引你的点？对实习的期望？ 加强实践
8. 比赛、项目 比较有挑战的事情 项目：1. 项目英文 2. 第一次接触分布式 sol: 多看文档 多用工具 多试，这里细问了工具类型 
9. 有用ai工具么 为什么没有用cursor？ai提供新的思路 开发模式
10. GPT还有什么场景用到？
11. GPT使用技巧？提示词？表述清晰？
12. 最近接触的比较多的比较有意思的技术/项目  知道了之后，有没有尝试去用 
13. ACM协会做什么？组织还是比赛为主？
14. 数据结构：有买卖方，有价格、数量和方向，按照最优的价格抵消，要维护一个这样有序的买卖盘。
